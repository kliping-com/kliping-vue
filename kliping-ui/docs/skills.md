...
- [Server MCP](/mcp) — menyambungkan server MCP untuk mengakses registry
- [Tema & Kustomisasi](/theming) — CSS variable dan penyesuaian tampilan
- [Registry](/registry/) — membangun dan menerbitkan registry sendiri
