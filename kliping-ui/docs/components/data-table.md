...
<ComponentPreview name="DataTableDemo" align="start" previewClass="items-start h-auto px-4 md:px-8" />
...
Berikut beberapa komponen yang bisa Anda pakai untuk membangun data table. Semuanya diambil dari demo Tasks.
