...
<template>
  <Card>
    <CardHeader>
      <CardTitle>Pemakaian Listrik</CardTitle>
      <CardDescription>Seluruh Rumah</CardDescription>
    </CardHeader>
    <CardContent class="flex flex-col gap-4">
      <div
        class="flex h-[140px] w-full items-end gap-2"
        role="img"
        aria-label="Pemakaian listrik per jam"
      >
        <div
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-0.5">
          <span class="text-sm text-muted-foreground">Dari Surya</span>
