...
Ingin merancang tema secara visual? Buka [halaman Buat](/create) untuk melihat pratinjau
...
Mode gelap bekerja dengan menimpa token yang sama di dalam selector `.dark`. Lihat [dokumentasi mode gelap](/docs/dark-mode) untuk memasang theme provider dan mengatur class `.dark`.
...
Token untuk chart dibahas lebih detail di [dokumentasi tema Chart](/docs/components/chart#theming).
